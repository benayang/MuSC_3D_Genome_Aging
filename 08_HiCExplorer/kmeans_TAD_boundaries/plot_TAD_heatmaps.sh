...
do
    ...
    --outFileName $outdir/aged.$feature.bin10kb.mat.gz \
    --referencePoint center -b 500000 -a 500000 \
    --binSize 10000 \
    -p 55

    plotHeatmap -m $outdir/aged.$feature.bin10kb.mat.gz \
    --outFileName $outdir/aged.$feature.bin10kb.png \
    ...
    -S $prefix/HistoneTracks/get_signal_bigwigs/$feature.count.rpkm.track.nodup.Aged.bw \
    --outFileName $outdir/young.$feature.bin10kb.mat.gz \
    --referencePoint center -b 500000 -a 500000 \
    --binSize 10000 \
    -p 55

    plotHeatmap -m $outdir/young.$feature.bin10kb.mat.gz \
    --outFileName $outdir/young.$feature.bin10kb.png \
    --xAxisLabel "distance (bp)" \
    --samplesLabel $feature \
